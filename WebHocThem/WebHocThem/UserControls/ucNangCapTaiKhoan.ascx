<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNangCapTaiKhoan.ascx.cs" Inherits="WebHocThem.UserControls.ucNangCapTaiKhoan" %>

<asp:Panel ID="Panel3" runat="server" DefaultButton="btnRegister" style="text-align: center;font-size: x-large;">
...
<h2 style="text-align: center;"> Nâng cấp tài khoản </h2>
    <hr />
<p class="fieldset">
...
<p class="fieldset">
  <%--  <asp:RequiredFieldValidator runat="server" ControlToValidate="input_email"
    ...
    <input class="full-width has-padding has-border" id="input_describe" name="describe" type="text" placeholder="Nội dung" runat="server">
</p>
<%--<p class="fieldset">
...
<p class="fieldset">
    ...
    <asp:Button ID="btnRegister" runat="server" OnClick="CreatePDK_Click" Text="Gửi yêu cầu" CssClass="btn-edit"/>
