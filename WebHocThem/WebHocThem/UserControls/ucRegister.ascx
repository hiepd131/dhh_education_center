...
<p class="fieldset">
    <asp:RequiredFieldValidator runat="server" ControlToValidate="input_email"
        CssClass="text-danger" ErrorMessage="Email không được để trống" />
    <i class="fa fa-envelope"></i>
    <input class="full-width has-padding has-border" style="margin:-10px" id="input_email" name="email" type="email" placeholder="Email đăng ký" runat="server">
</p>
<%--<p class="fieldset">
...
<p class="fieldset" >
    <asp:RequiredFieldValidator runat="server" ControlToValidate="input_password"
        CssClass="text-danger" ErrorMessage="Mật khẩu không được để trống." />
    <i class="fa fa-key"></i>
...
<p class="fieldset">
    <asp:RequiredFieldValidator runat="server" ControlToValidate="input_repassword"
        CssClass="text-danger" Display="Dynamic" ErrorMessage="Mật khẩu xác nhận không được để trống." />
    <asp:CompareValidator runat="server" ControlToCompare="input_password" ControlToValidate="input_repassword"
        CssClass="text-danger" Display="Dynamic" ErrorMessage="Mật khẩu xác nhận không khớp với mật khẩu" />
    <i class="fa fa-key"></i>
...
<p class="fieldset">
    ...
    <asp:Button ID="btnRegister" runat="server" OnClick="CreateUser_Click" Text="Đăng Ký" CssClass="btn-edit"/>
