<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucTuyenDung.ascx.cs" Inherits="WebHocThem.UserControls.ucTuyenDung" %>
<asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="TuyenDung" Visible="False">
    <AlternatingItemTemplate>
        <li style="background-color: #FFF8DC;">ID:
            ...
            <br />
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"/TuyenDungDK.aspx?lop="+Eval("ID") %>'>Ứng tuyển</asp:HyperLink>
        </li>
    </AlternatingItemTemplate>
    <EditItemTemplate>
    ...
    <EmptyDataTemplate>
        <h2 style="text-align:center">Chưa có lớp học nào được mở để ứng tuyển</h2>
    </EmptyDataTemplate>
    <InsertItemTemplate>
        <li style="">ID:
...
<asp:SqlDataSource ID="TuyenDung" runat="server" ConnectionString="<%$ ConnectionStrings:DBWebHocThemConnectionString %>" SelectCommand="tTUYENDUNG" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
