...
<asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource1">
    ...
    <EmptyDataTemplate>
        <h2 class="text-danger" style="text-align:center">Các lớp hiện tại chưa xếp đủ Thời Khóa Biểu</h2>
    </EmptyDataTemplate>
    <InsertItemTemplate>
        <li style="">ID:
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBWebHocThemConnectionString %>" SelectCommand="tLOPHOCKH" SelectCommandType="StoredProcedure">
    <SelectParameters>
