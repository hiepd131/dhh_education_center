    ...
    public partial class ucRegister : System.Web.UI.UserControl
    {
        ...
        protected void CreateUser_Click(object sender, EventArgs e)
        {
            ...
            if (result.Succeeded)
            {
                ...
                SendMail.SendEmail(user.Email, "Xác nhận tài khoản", "Vui lòng click vào link dưới đây để xác nhận <a href=\"" + callbackUrl + "\">tại đây</a>.","");
                ...
                {
                    ErrorMessage.Text = "Email xác nhận tài khoản đã được gửi đến cho bạn. Hãy kiểm tra hộp thư và xác nhận để hoàn tât quá trình đăng ký !.";
                }
            }
            else
            {
