<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPhieuDanhGia.ascx.cs" Inherits="WebHocThem.UserControls.ucPhieuDanhGia" %>
<asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="PhieuDanhGia">
    <AlternatingItemTemplate>
        <li style="background-color: #FFF8DC;">ID:
            ...
            <br />
             <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "/PhieuDanhGiaLH.aspx?pdk="+ Eval("ID1") %>'>Đánh giá</asp:HyperLink>
        </li>
    </AlternatingItemTemplate>
    <EditItemTemplate>
    ...
    <EmptyDataTemplate>
        <h2 class="text-danger" style="text-align:center">Bạn chưa hoàn thành khóa học nào để đánh giá</h2>
    </EmptyDataTemplate>
    <InsertItemTemplate>
        <li style="">ID:
...
<asp:SqlDataSource ID="PhieuDanhGia" runat="server" ConnectionString="<%$ ConnectionStrings:DBWebHocThemConnectionString %>" SelectCommand="tLOPPDG" SelectCommandType="StoredProcedure">
    <SelectParameters>
